...
public class UsuarioController {
	...
	@PostMapping("/logar")
	private ResponseEntity<UsuarioLogin> logar(@Valid @RequestBody Optional<UsuarioLogin> usuarioLogin){
	...
	private ResponseEntity<Usuario> cadastrar(@Valid @RequestBody Usuario usuario){
	...
	private ResponseEntity<Usuario> atualizar(@Valid @RequestBody Usuario usuario){
